...
message = [
    {
        "role": "system",
        "content": "You are a Python expert software engineer that prefers functional programming.",
    },
...
message = [
    ...
    {
        "role": "user",
        "content": "Add comprehensive documentation including: Function description, Parameter descriptions, Return value description, Example usage, Edge cases.",
    },
]
response = generate_response(message)
print(response)
...
message = [
    ...
    {
        "role": "user",
        "content": "Add test cases using Python’s unittest framework. Tests should cover: Basic functionality, Edge cases, Error cases, Various input scenarios.",
    },
]
response = generate_response(message)
print(response)
